# Creamos una carpeta con el nombre de rutas, dentro creamos un archivo con el nombre "cv.py".

# Colocaremos los lugares y sus coordenadas que podemos obtener por medio del maps.
